...
# $Id: makefile.h 27719 2015-10-15 22:30:45Z edo $
#
...
ifdef OPTIMIZE
    FFLAGS = $(FOPTIONS) $(FOPTIMIZE) $(BLASOPT)
    CFLAGS =  $(COPTIONS) $(COPTIMIZE) $(BLASOPT)
else
# Need FDEBUG after FOPTIONS on SOLARIS to correctly override optimization
    FFLAGS = $(FOPTIONS) $(FDEBUG) $(BLASOPT)
    CFLAGS = $(COPTIONS) $(CDEBUG) $(BLASOPT)
endif
